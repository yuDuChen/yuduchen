$("<link>").attr({
	...
	$.getScript("https://cdn.jsdelivr.net/gh/yuDuChen/yuduchen@v1.5.2/live2d/assets/waifu-tips.js", function() {
		console.log("加载waifu-tips.js--success")
		$.getScript("https://cdn.jsdelivr.net/gh/yuDuChen/yuduchen@v1.5.2/live2d/assets/live2d.js", function() {
			...
			/* 在 initModel 前添加 */
			initModel('https://cdn.jsdelivr.net/gh/yuDuChen/yuduchen@v1.5.2/live2d/assets/waifu-tips.json');
		});
	});
